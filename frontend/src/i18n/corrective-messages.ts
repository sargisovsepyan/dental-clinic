...
const copy = {
  "en": {
    ...
    "invalidPhone": "Enter digits, an optional leading +, spaces, parentheses or hyphens.",
  ...
  "ru": {
    ...
    "invalidPhone": "Введите цифры, необязательный + в начале, пробелы, скобки или дефис.",
  ...
  "hy": {
    ...
    "invalidPhone": "Մուտքագրեք թվեր, սկզբի ոչ պարտադիր + նշան, բացատներ, փակագծեր կամ գծիկ։",
